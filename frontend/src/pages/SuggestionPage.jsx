...
export default function SuggestionPage() {
  ...
  return (
    <div className="flex items-center justify-center py-24">
      <div className=" bg-white/20 p-8 rounded-2xl shadow-xl w-[90%] max-w-lg">
        ...
        <form onSubmit={submit}>
          <textarea
            ...
            className="w-full p-3 text-stone-900 rounded-lg bg-white/80 focus:outline-none focus:ring-2 focus:ring-purple-500"
          />
